...
/** @typedef {import('@opencode-ai/plugin-v1/tui').TuiPlugin} TuiPlugin */
/** @typedef {import('@opencode-ai/plugin-v1/tui').TuiPluginApi} TuiPluginApi */
/** @typedef {import('@opencode-ai/plugin-v1/tui').TuiPluginModule} TuiPluginModule */
